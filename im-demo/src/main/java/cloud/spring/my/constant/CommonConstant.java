package cloud.spring.my.constant;
...
public interface CommonConstant {
    ...
    /** 登录用户Shiro权限缓存KEY前缀 */
    public static String PREFIX_USER_SHIRO_CACHE  = "shiro:cache:org.jeecg.cloud.spring.my.study.config.shiro.ShiroRealm.authorizationCache:";
    /** 登录用户Token令牌缓存KEY前缀 */
    public static final String PREFIX_USER_TOKEN  = "prefix_user_token:";
    public static final String USER_PHONE  = "single_phone:";
    String PT_USER  = "PT_";
    /** Token缓存时间：3600秒即一小时 */
